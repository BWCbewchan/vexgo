...
Blockly.ContextMenu.show = function(e, options, rtl) {
  ...
  var menu = Blockly.ContextMenu.populate_(options, rtl, e);// RM Code Changes
 ...
 * @private
 */
Blockly.ContextMenu.populate_ = function(options, rtl, e) {
  ...
  */
  ...
  for (var i = 0, option; (option = options[i]); i++) {
    ...
    if (option.enabled) {
      // RM Code Start
      var actionHandler = function(_menuItem, e) {
        var option = this;
        Blockly.ContextMenu.hide();
        option.callback(option.scope, e);
      };
