 ...
 */
Blockly.utils.dom.createDom = function(tagName) {
  'use strict';
  var element = Blockly.utils.dom.createElement_(document, tagName);
 ...
 * @private
 */
Blockly.utils.dom.createElement_ = function(doc, name) {
  'use strict';
  name = String(name);
