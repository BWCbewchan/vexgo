...
Blockly.FlyoutButton = function(workspace, targetWorkspace, json, isLabel) {
   ...
   * @private
   */
  this.isCategoryLabel_ = json['category-label'];
  // RM Code End
 ...
 */
Blockly.FlyoutButton.MARGIN_X = 40; // RM Change - change from 5 to 40 to match scratch
...
Blockly.FlyoutButton.prototype.createDom = function() {
  ...
  this.height = Math.max(fontMetrics.height, Blockly.FlyoutButton.MIN_HEIGHT);
 ...
 */
Blockly.FlyoutButton.MIN_HEIGHT = 40;
