 ...
 * @constructor
 */
Blockly.VariableModel = function(workspace, name, opt_type, opt_id, opt_arrayLength, opt_arrayWidth) {
  /**
   ...
   * @package
   */
  this.arrayLength = opt_arrayLength || 0;
   ...
   * @package
   */
  this.arrayWidth = opt_arrayWidth || 0;
