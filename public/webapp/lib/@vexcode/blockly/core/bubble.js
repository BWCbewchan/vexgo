...
// RM Code Start
// Original value: 5
Blockly.Bubble.ARROW_THICKNESS = 2;
// RM Code End
/**
  ...
  */
  ...
  this.bubbleBack_ = Blockly.utils.dom.createSvgElement(
      Blockly.utils.Svg.RECT, {
        // RM Code Start
        // Original: 'class': 'blocklyDraggable',
        'class': '',
        // RM Code End
        'x': 0,
        'y': 0,
...
Blockly.Bubble.prototype.renderArrow_ = function() {
  ...
  // RM Code Start
  // original: var relBubbleX = this.width_;
  var relBubbleX = this.width_;
  // RM Code End
  ...
  if (this.workspace_.RTL) {
    relBubbleX = 0;
    relAnchorX = -(this.relativeLeft_ + this.width_);
  }
  // RM Code End
 ...
 * @package
 */
Blockly.Bubble.prototype.moveDuringDrag = function(_dragSurface, _newLoc) {
  // RM Code Start
  // '_dragSurface' -> 'dragSurface' originally
  // '_newLoc' -> 'newLoc' originally
  // Commented out below to disable dragging on an error panel
  // if (dragSurface) {
