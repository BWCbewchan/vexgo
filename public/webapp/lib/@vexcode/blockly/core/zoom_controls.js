...
Blockly.ZoomControls.prototype.createZoomOutSvg_ = function(rnd) {
  ...
  <g class="blocklyZoom">
    <image width="36" height="36" y="44" xlink:href="media/zoom-out.svg"></image>
  </g>
  */
  ...
  zoomoutSvg.setAttributeNS(Blockly.utils.dom.XLINK_NS, 'xlink:href',
      // RM Code Start
      this.workspace_.options.pathToMedia + 'zoom-out.svg');
      // RM Code End
...
Blockly.ZoomControls.prototype.createZoomInSvg_ = function(rnd) {
  /* This markup will be generated and added to the .svgGroup_:
  <g class="blocklyZoom">
    <image width="36" height="36" y="0" xlink:href="media/zoom-in.svg"></image>
  </g>
  */
  ...
  zoominSvg.setAttributeNS(Blockly.utils.dom.XLINK_NS, 'xlink:href',
      // RM Code Start
      this.workspace_.options.pathToMedia + 'zoom-in.svg');
      // RM Code End
...
Blockly.ZoomControls.prototype.createZoomResetSvg_ = function(rnd) {
  /* This markup will be generated and added to the .svgGroup_:
  <g class="blocklyZoom">
    <image width="36" height="36" y="88" xlink:href="media/zoom-reset.svg"></image>
  </g>
  */
  ...
  zoomresetSvg.setAttributeNS(Blockly.utils.dom.XLINK_NS, 'xlink:href',
      // RM Code Start
      this.workspace_.options.pathToMedia + 'zoom-reset.svg');
      // RM Code End
