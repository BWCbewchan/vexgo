...
// RM Code Start
goog.provide('Blockly.blockRendering.RoundCornerLarge');
// RM Code End
 ...
 * @extends {Blockly.blockRendering.Measurable}
 */
Blockly.blockRendering.RoundCornerLarge = function(constants, opt_position) {
  Blockly.blockRendering.RoundCornerLarge.superClass_.constructor.call(this,
      constants);
  this.type = ((!opt_position || opt_position == 'left') ?
      Blockly.blockRendering.Types.LEFT_LARGE_ROUND_CORNER :
      Blockly.blockRendering.Types.RIGHT_LARGE_ROUND_CORNER) |
          Blockly.blockRendering.Types.CORNER;
  this.width = this.constants_.START_HAT_HEIGHT;
  // The rounded corner extends into the next row by 4 so we only take the
  // height that is aligned with this row.
  this.height = this.constants_.START_HAT_HEIGHT / 2;

};
Blockly.utils.object.inherits(Blockly.blockRendering.RoundCornerLarge,
    Blockly.blockRendering.Measurable);
// RM Code End
