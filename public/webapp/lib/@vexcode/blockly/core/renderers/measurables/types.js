...
Blockly.blockRendering.Types = {
  ...
  // RM Code Start
  LEFT_LARGE_ROUND_CORNER: 1 << 24,   // Round Corner.
  RIGHT_LARGE_ROUND_CORNER: 1 << 25,  // Right Round Corner.
  // RM Code End
};
 ...
 * @package
 */
Blockly.blockRendering.Types.isLeftLargeRoundedCorner = function(elem) {
  return elem.type & Blockly.blockRendering.Types.LEFT_LARGE_ROUND_CORNER;
};
 ...
 * @package
 */
Blockly.blockRendering.Types.isRightLargeRoundedCorner = function(elem) {
  return elem.type & Blockly.blockRendering.Types.RIGHT_LARGE_ROUND_CORNER;
};
