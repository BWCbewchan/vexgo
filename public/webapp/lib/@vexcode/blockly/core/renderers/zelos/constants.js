...
Blockly.zelos.ConstantProvider = function() {
   ...
   * @type {string}
   */
  this.ERROR_HIGHLIGHTED_GLOW_COLOUR = '#FF0000';

  /**
   * The size of the highlighted glow.
   * @type {number}
   */
  this.ERROR_HIGHLIGHTED_GLOW_SIZE = 0.7;
  // RM Code End
   ...
   * @package
   */
  this.errorHighlightedGlowFilterId = '';
  ...
  /**
     ...
     * @private
     */
  this.errorHighlightedGlowFilter_ = null;
  // RM Code End
...
Blockly.zelos.ConstantProvider.prototype.createDom = function(svg,
  ...
  */
  ...
  //  ---- ERROR
  var errorHighlightedGlowFilter = Blockly.utils.dom.createSvgElement(
      Blockly.utils.Svg.FILTER,
      {
        'id': 'blocklyErrorHighlightedGlowFilter' + this.randomIdentifier,
        'height': '160%',
        'width': '180%',
        y: '-30%',
        x: '-40%'
  ...
  Blockly.utils.dom.createSvgElement(
      ...
      {
        'in': 'SourceGraphic',
        'stdDeviation': this.ERROR_HIGHLIGHTED_GLOW_SIZE
      },
      errorHighlightedGlowFilter);
  // Set all gaussian blur pixels to 1 opacity before applying flood
  var errorHighlightedComponentTransfer = Blockly.utils.dom.createSvgElement(
      Blockly.utils.Svg.FECOMPONENTTRANSFER, {
        'result': 'outBlur'
      }, errorHighlightedGlowFilter);
  Blockly.utils.dom.createSvgElement(
      ...
      errorHighlightedComponentTransfer);
  // Color the highlight
  Blockly.utils.dom.createSvgElement(
      Blockly.utils.Svg.FEFLOOD,
      {
        'flood-color': this.ERROR_HIGHLIGHTED_GLOW_COLOUR,
        'flood-opacity': 1,
        'result': 'outColor'
      },
      errorHighlightedGlowFilter);
  Blockly.utils.dom.createSvgElement(
      ...
      errorHighlightedGlowFilter);
  this.errorHighlightedGlowFilterId = errorHighlightedGlowFilter.id;
  this.errorHighlightedGlowFilter_ = errorHighlightedGlowFilter;
