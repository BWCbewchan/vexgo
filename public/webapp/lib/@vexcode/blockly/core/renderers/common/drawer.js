...
Blockly.blockRendering.Drawer.prototype.drawTop_ = function() {
  ...
  for (var i = 0, elem; (elem = elements[i]); i++) {
    ...
    // RM Code Start
    } else if (Blockly.blockRendering.Types.isLeftLargeRoundedCorner(elem)) {
      this.outlinePath_ +=
          this.constants_.LARGE_OUTSIDE_CORNERS.topLeft;
    } else if (Blockly.blockRendering.Types.isRightLargeRoundedCorner(elem)) {
      this.outlinePath_ +=
          this.constants_.LARGE_OUTSIDE_CORNERS.topRight;
    // RM Code End
