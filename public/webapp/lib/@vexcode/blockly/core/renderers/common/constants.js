...
Blockly.blockRendering.ConstantProvider = function() {
   ...
   * @type {string}
   */
    this.FIELD_DROPDOWN_SVG_ARROW_DATAURI_DARK =
...
Blockly.blockRendering.ConstantProvider.prototype.createDom = function(svg,
  ...
  */
  ...
  Blockly.utils.dom.createSvgElement(
      ...
      {'in': 'SourceAlpha', 'stdDeviation': .5, 'result': 'blur'}, embossFilter);
  ...
  */
  ...
  Blockly.utils.dom.createSvgElement(
      ...
      {'width': 15, 'height': 15, 'fill': '#aaa'}, disabledPattern);
  Blockly.utils.dom.createSvgElement(
      Blockly.utils.Svg.PATH,
      {'d': 'M 0 0 L 10 10 M 10 0 L 0 10', 'stroke': '#8a8a8a', 'stroke-width': 1}, disabledPattern);
