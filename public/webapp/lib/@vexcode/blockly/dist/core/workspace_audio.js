...
Blockly.WorkspaceAudio.prototype.play = function(name, opt_volume) {
  ...
  if (sound) {
    // RM Code Start
    if (!this.playSounds) {
      // if we are set to not play sounds, there is no point doing anything else.
      return;
    }
    // RM Code End
 ...
 */
Blockly.WorkspaceAudio.prototype.disableSounds = function() {
 ...
 */
Blockly.WorkspaceAudio.prototype.enableSounds = function() {
