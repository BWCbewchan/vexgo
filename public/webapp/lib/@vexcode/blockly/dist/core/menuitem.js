 ...
 * @package
 */
Blockly.MenuItem.prototype.performAction = function(e) {// RM Code Changes - added Event param
  if (this.isEnabled() && this.actionHandler_) {
    this.actionHandler_(this, e);// RM Code Changes - pass Event e
  }
};
 ...
 * @package
 */
Blockly.MenuItem.prototype.onAction = function(fn, obj) {// RM Code Changes - added Event param to fn
