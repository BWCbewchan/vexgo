...
Blockly.BlockSvg.prototype.generateContextMenu = function(e) {// RM Code Changes
  ...
  if (this.isInFlyout) {
    if(this.type.includes("array") || this.type.includes('sensing') || this.type.includes('variable')) {
      return menuOptions.filter(({ text }) =>
        text === "Rename variable" || text === 'Add to Monitor' || (text.includes("Delete the"))
      );
    } else {
      return 
    }
 ...
 */
Blockly.BlockSvg.prototype.addErrorHighlight = function() {
  if (this.pathObject.updateErrorHighlighted) {
    this.pathObject.updateErrorHighlighted(true);
  }
};
 ...
 */
Blockly.BlockSvg.prototype.removeErrorHighlight = function() {
  if (this.pathObject.updateErrorHighlighted) {
    this.pathObject.updateErrorHighlighted(false);
  }
};
// RM Code End
