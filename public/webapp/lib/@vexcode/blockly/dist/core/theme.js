 ...
 * @constructor
 */
Blockly.Theme = function(name, suffix, opt_blockStyles, opt_categoryStyles,
    opt_componentStyles) {
  ...
  // RM Code Start - VEXcode addition to set dropdown/mutator arrow SVGs off of
  /**
