...
Blockly.utils.colour.parse = function(str) {
  ...
  if (/^#[0-9a-f]{4}$/.test(hex)) {
    // e.g. '#0f8a'
    return ['#', hex[1], hex[1], hex[2], hex[2], hex[3], hex[3], hex[4], hex[4]].join('');
  }
  // RM Code End
 ...
 */
Blockly.utils.colour.rgbaToHex = function(r, g, b, a) {
  // Pulled from google closure
 ...
 */
Blockly.utils.colour.hexToRgba = function(hexColor) {
