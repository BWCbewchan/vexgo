...
Blockly.duplicate = function(toDuplicate, x, y) {// RM Code Changes
  if (window && window.dispatchEvent) {
    window.dispatchEvent(new CustomEvent("researchDuplicate"))
  }
 ...
 */
Blockly.prompt = function(message, defaultValue, callback, opt_title, opt_varType, validator) {
