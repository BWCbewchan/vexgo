"use strict";
(self["webpackChunkwebapp"] = self["webpackChunkwebapp"] || []).push([["src_HardwareInterface_DownloadPlatform_EXP_EXPVexSerial_ts"],{

/***/ "./src/HardwareInterface/DownloadPlatform/EXP/EXPVexSerial.ts":
/*!********************************************************************!*\
  !*** ./src/HardwareInterface/DownloadPlatform/EXP/EXPVexSerial.ts ***!
  \********************************************************************/
...
/* harmony export */   EXPVexSerial: () => (/* binding */ EXPVexSerial)
/* harmony export */ });
...
/* harmony import */ var _CTE_armInterface__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../CTE/armInterface */ "./src/HardwareInterface/CTE/armInterface.ts");
...
var log = _rm_vca_logger__WEBPACK_IMPORTED_MODULE_0__.getLogger("EXPVexSerial");
...
var EXPVexSerial = /*#__PURE__*/function (_EXPInterface) {
  function EXPVexSerial() {
    var _this;
    _classCallCheck(this, EXPVexSerial);
    _this = _callSuper(this, EXPVexSerial);
    // tslint:disable-next-line: variable-name
    _defineProperty(_this, "_serial", new _VexSerialDevices__WEBPACK_IMPORTED_MODULE_4__.VexSerialDeviceEXP());
    ...
    _defineProperty(_this, "onConnectedToInvalidPort", function () {
      ...
      var message = _i18n_i18n__WEBPACK_IMPORTED_MODULE_9__.i18n.t("Incorrect WebSerial Port", {
        platform: _i18n_i18n__WEBPACK_IMPORTED_MODULE_9__.i18n.t("EXP")
      });
      _widget_Modal__WEBPACK_IMPORTED_MODULE_6__.MODALCONTROL.showWebSerialPrompt(message, null, _this.onControlButtonClick);
    });
    _defineProperty(_this, "onConnectedToArm", function () {
      _this.closeConnection().then(function () {
        // we need to actually open the connection. We previously just set the
        // state, but that resulted in some code running since it thought that
        // there was an active connection, but it would error out when it found
        // there was no connection. As a result it is safer to just open the
        // connection. Since it was already opened, there is no need to have
        // the user do anything for this.
        _CTE_armInterface__WEBPACK_IMPORTED_MODULE_14__.armInterface.genericComm.openEstablished();
      });
    });
    ...
    _this._serial.on("connectedToArm", _this.onConnectedToArm);
    _this.onControlButtonClick = _this.onControlButtonClick.bind(_this);
  ...
  _inherits(EXPVexSerial, _EXPInterface);
  return _createClass(EXPVexSerial, [{
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              throw new _types_HWErrors__WEBPACK_IMPORTED_MODULE_2__.OperationNotSupportedError("BLE connection is not supported for EXP Vex Serial");
            case 5:
    ...
    value: function getRobotInfoUSB() {
      ...
      var info = {
        ...
        robotNeedsFirmwareUpdate: tmpInfo.updateNeededBrain ? _types_HWEnums__WEBPACK_IMPORTED_MODULE_1__.UpdateNeededOptions.NeedsUpdate : _types_HWEnums__WEBPACK_IMPORTED_MODULE_1__.UpdateNeededOptions.UpToDate,
        ...
        return _regeneratorRuntime().wrap(function _callee11$(_context11) {
          while (1) switch (_context11.prev = _context11.next) {
            ...
            case 16:
              ...
              if (_context11.t0 instanceof _VexSerialDevices_errors__WEBPACK_IMPORTED_MODULE_11__.WebSerialUnsupportedError) {
                msg1Key = "WebSerial Update Failed - webserial not supported";
              } else if (_context11.t0 instanceof _VexSerialDevices_errors__WEBPACK_IMPORTED_MODULE_11__.NoBrainConnectedError) {
                msg1Key = "WebSerial Update Failed - no device";
              } else if (_context11.t0 instanceof _VexSerialDevices_errors__WEBPACK_IMPORTED_MODULE_11__.OperationNotSupportedError) {
                msg1Key = "WebSerial Update Failed - not supported";
              } else if (_context11.t0 instanceof _VexSerialDevices_errors__WEBPACK_IMPORTED_MODULE_11__.ErrorUpdatingBrainGolden) {
                msg1Key = "WebSerial Update Failed - recovery update failed";
              } else if (_context11.t0 instanceof _VexSerialDevices_errors__WEBPACK_IMPORTED_MODULE_11__.ErrorUpdatingBrainBoot) {
                msg1Key = "WebSerial Update Failed - main update failed";
              } else if (_context11.t0 instanceof _VexSerialDevices_errors__WEBPACK_IMPORTED_MODULE_11__.ErrorUpdatingBrainAssets) {
    ...
    value: function () {
      var _updateControllerFirmware = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee12(progress) {
        var isDFU,
          force,
          updateState,
        ...
        return _regeneratorRuntime().wrap(function _callee12$(_context12) {
          while (1) switch (_context12.prev = _context12.next) {
            case 0:
              isDFU = _args12.length > 1 && _args12[1] !== undefined ? _args12[1] : false;
              force = _args12.length > 2 && _args12[2] !== undefined ? _args12[2] : false;
              ...
              _widget_Modal__WEBPACK_IMPORTED_MODULE_6__.MODALCONTROL.showWebControllerUpdateProgress(_updateProgressEvent, _requestConnectEvent, reconnectCallback);
              progressHandler = function progressHandler(state, percent, msg) {
            ...
            case 18:
              ...
              if (_context12.t0 instanceof _VexSerialDevices_errors__WEBPACK_IMPORTED_MODULE_11__.WebSerialUnsupportedError) {
                msg1Key = "WebSerial Update Failed - webserial not supported";
              } else if (_context12.t0 instanceof _VexSerialDevices_errors__WEBPACK_IMPORTED_MODULE_11__.NoControllerConnectedError) {
                msg1Key = "WebSerial Update Failed - no device";
              } else if (_context12.t0 instanceof _VexSerialDevices_errors__WEBPACK_IMPORTED_MODULE_11__.OperationNotSupportedError) {
                msg1Key = "WebSerial Update Failed - not supported";
              } else if (_context12.t0 instanceof _VexSerialDevices_errors__WEBPACK_IMPORTED_MODULE_11__.UpdateCanceled) {
      ...
      function updateControllerFirmware(_x14) {
    ...
    value: function () {
      ...
      function openConnectionUserPort(_x15) {
    ...
    value: function () {
      ...
      function closeConnectionUserPort(_x16) {
...
//# sourceMappingURL=c7f2e80f419e867769eb.src_HardwareInterface_DownloadPlatform_EXP_EXPVexSerial_ts.bundle.js.map