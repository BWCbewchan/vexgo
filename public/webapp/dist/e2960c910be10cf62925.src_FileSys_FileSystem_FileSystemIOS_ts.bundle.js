"use strict";
(self["webpackChunkwebapp"] = self["webpackChunkwebapp"] || []).push([["src_FileSys_FileSystem_FileSystemIOS_ts"],{

/***/ "./src/FileSys/FileSystem/FileSystemIOS.ts":
/*!*************************************************!*\
  !*** ./src/FileSys/FileSystem/FileSystemIOS.ts ***!
  \*************************************************/
...
/* harmony export */   FileSystemIOS: () => (/* binding */ FileSystemIOS)
/* harmony export */ });
...
var log = _rm_vca_logger__WEBPACK_IMPORTED_MODULE_0__.getLogger("FileSystemIOS");
...
/**
 * the class for all iOS file system operations
 * 
 */
var FileSystemIOS = /*#__PURE__*/function (_FileSystemBase) {
  function FileSystemIOS() {
    _classCallCheck(this, FileSystemIOS);
    return _callSuper(this, FileSystemIOS, arguments);
  }
  _inherits(FileSystemIOS, _FileSystemBase);
  return _createClass(FileSystemIOS, [{
    key: "canLoadFromURI",
    get:
    //#region information
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              log.error("unable to read file. no path data in the file ref");
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              log.error("unable to write file. no path data in the file ref");
              throw new _FileSystemErrors__WEBPACK_IMPORTED_MODULE_2__.ErrorFSFileRefInvalidData();
            case 5:
              _context4.next = 7;
    ...
    value: function () {
      var _renameFile = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(fileRef, newName) {
        var uri, ext, dirPath, newPath, renamed, newFileRef;
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              ...
              log.error("unable to rename file. no path data in the file ref", fileRef);
              throw new _FileSystemErrors__WEBPACK_IMPORTED_MODULE_2__.ErrorFSFileRefInvalidData();
            case 5:
              ...
              log.error("unable to rename file. no extension in the file ref", fileRef);
              throw new _FileSystemErrors__WEBPACK_IMPORTED_MODULE_2__.ErrorFSFileRefInvalidData();
            case 9:
              dirPath = (0,_helpers__WEBPACK_IMPORTED_MODULE_3__.getPathFromURI)(uri);
              newPath = "".concat(dirPath, "/").concat(encodeURIComponent(newName), ".").concat(ext); // Make sure the file does not already exist.
              _context6.next = 13;
              return (0,_nativeInterface__WEBPACK_IMPORTED_MODULE_4__.renameNativeFile)(uri, newPath);
            case 13:
              renamed = _context6.sent;
              if (renamed) {
                _context6.next = 16;
                break;
              }
              throw new _FileSystemErrors__WEBPACK_IMPORTED_MODULE_2__.ErrorFSRenameError();
            case 16:
              newFileRef = {
                name: newName,
                pathData: newPath,
      ...
      var _requestWritePermission = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8(fileRef) {
        return _regeneratorRuntime().wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            case 0:
              log.warn("requestWritePermission should not get called for iOS");
    ...
    value: function () {
      var _selectFileToOpen2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee9(fileRef) {
        var uri, ext, newFileRef;
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            case 0:
              log.info("selectFileToOpen", fileRef);

              // TODO: see if there is a way this can be improved to return a reason when the select fails
              // TODO: make sure there are no errors that need to be handled
              _context9.next = 3;
            ...
            case 7:
              ext = (0,_helpers__WEBPACK_IMPORTED_MODULE_3__.getExtensionFromURI)(uri);
              newFileRef = {
                name: (0,_helpers__WEBPACK_IMPORTED_MODULE_3__.getNameFromURI)(uri, ext),
                pathData: uri,
                fileExtension: ext,
                hasWritePermission: true,
                hasFolderWritePermissions: true
    ...
    value: function () {
      var _selectFileToSave2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee10(fileRef) {
        var ext, currentName, uri, newFileRef;
        return _regeneratorRuntime().wrap(function _callee10$(_context10) {
          while (1) switch (_context10.prev = _context10.next) {
            ...
            case 11:
              ...
              log.error("There was an issue selecting the file");
              throw new _FileSystemErrors__WEBPACK_IMPORTED_MODULE_2__.ErrorFSFileNotFound();
            case 15:
              newFileRef = {
                name: (0,_helpers__WEBPACK_IMPORTED_MODULE_3__.getNameFromURI)(uri, ext),
...
//# sourceMappingURL=e2960c910be10cf62925.src_FileSys_FileSystem_FileSystemIOS_ts.bundle.js.map