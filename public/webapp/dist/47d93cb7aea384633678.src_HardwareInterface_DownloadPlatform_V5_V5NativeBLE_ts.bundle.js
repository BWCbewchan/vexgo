"use strict";
(self["webpackChunkwebapp"] = self["webpackChunkwebapp"] || []).push([["src_HardwareInterface_DownloadPlatform_V5_V5NativeBLE_ts"],{

/***/ "./src/HardwareInterface/DownloadPlatform/V5/V5NativeBLE.ts":
/*!******************************************************************!*\
  !*** ./src/HardwareInterface/DownloadPlatform/V5/V5NativeBLE.ts ***!
  \******************************************************************/
...
/* harmony export */   V5NativeBLE: () => (/* binding */ V5NativeBLE)
/* harmony export */ });
...
/* harmony import */ var _vexcode_python_vm__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @vexcode/python-vm */ "./node_modules/@vexcode/python-vm/dist/index.js");
/* harmony import */ var _types_HWTabletEnums__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../types/HWTabletEnums */ "./src/HardwareInterface/types/HWTabletEnums.ts");
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../../helpers */ "./src/helpers.ts");
/* harmony import */ var _StorageInterface_VEXcodeLocalStorage__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../../StorageInterface/VEXcodeLocalStorage */ "./src/StorageInterface/VEXcodeLocalStorage.ts");
...
var V5NativeBLE = /*#__PURE__*/function (_V5Interface) {
  function V5NativeBLE() {
    var _this;
    _classCallCheck(this, V5NativeBLE);
    _this = _callSuper(this, V5NativeBLE);
  ...
  _inherits(V5NativeBLE, _V5Interface);
  return _createClass(V5NativeBLE, [{
                  ...
                  return _regeneratorRuntime().wrap(function _callee7$(_context7) {
                    while (1) switch (_context7.prev = _context7.next) {
                      case 0:
                        ...
                        _context7.next = 6;
                        return _this4.checkPythonVm(_vexcode_python_vm__WEBPACK_IMPORTED_MODULE_14__.metaV5.crc, _vexcode_python_vm__WEBPACK_IMPORTED_MODULE_14__.metaV5.version);
                      case 6:
                        ...
                        _context7.next = 13;
                        return (0,_helpers__WEBPACK_IMPORTED_MODULE_16__.waitms)(1000);
                      case 13:
                        _context7.t0 = atob;
                        _context7.next = 16;
                      ...
                      case 16:
                        ...
                        _context7.next = 21;
                        return _this4.DownloadFileRaw(vmArrayBuffer, "python_vm", "bin", _types_HWTabletEnums__WEBPACK_IMPORTED_MODULE_15__.VEXosExtType.VEXVM, 0x03800000, _types_HWTabletEnums__WEBPACK_IMPORTED_MODULE_15__.VEXosVID.NONE, undefined, _types_HWTabletEnums__WEBPACK_IMPORTED_MODULE_15__.VEXosDownloadTarget.FILE_TARGET_QSPI, _types_HWTabletEnums__WEBPACK_IMPORTED_MODULE_15__.VEXosVID.VEXVM, _vexcode_python_vm__WEBPACK_IMPORTED_MODULE_14__.metaV5.version, function (percent) {
                          progressCallback({
                            progress: percent,
                            step: _types_HWEnums__WEBPACK_IMPORTED_MODULE_1__.DownloadState.DownloadingVM
                          });
                      ...
                      case 26:
                        ...
                        extType = isPython ? _types_HWTabletEnums__WEBPACK_IMPORTED_MODULE_15__.VEXosExtType.VEXVM : _types_HWTabletEnums__WEBPACK_IMPORTED_MODULE_15__.VEXosExtType.General;
                        loadAddress = isPython ? 0x07000000 : 0x03800000;
                        linkFileVID = isPython ? _types_HWTabletEnums__WEBPACK_IMPORTED_MODULE_15__.VEXosVID.VEXVM : _types_HWTabletEnums__WEBPACK_IMPORTED_MODULE_15__.VEXosVID.NONE;
                        linkFileName = isPython ? "python_vm.bin" : null;
                        downloadTarget = _types_HWTabletEnums__WEBPACK_IMPORTED_MODULE_15__.VEXosDownloadTarget.FILE_TARGET_QSPI;
                        _context7.next = 34;
                        return _this4.DownloadProjectFiles(fileName, binAB, iniAB, undefined, extType, loadAddress, linkFileVID, linkFileName, downloadTarget, _types_HWTabletEnums__WEBPACK_IMPORTED_MODULE_15__.VEXosVID.USER, progressEventWrapper);
                      case 34:
        ...
        return _regeneratorRuntime().wrap(function _callee14$(_context14) {
          while (1) switch (_context14.prev = _context14.next) {
            ...
            case 4:
              ...
              vmArrayBuffer = (0,_helpers__WEBPACK_IMPORTED_MODULE_5__.stringToArrayBuffer)(vmDataString);
              _context14.next = 9;
              return this.DownloadFileRaw(vmArrayBuffer, "python_vm", "bin", _types_HWTabletEnums__WEBPACK_IMPORTED_MODULE_15__.VEXosExtType.VEXVM, 0x03800000, _types_HWTabletEnums__WEBPACK_IMPORTED_MODULE_15__.VEXosVID.NONE, undefined, _types_HWTabletEnums__WEBPACK_IMPORTED_MODULE_15__.VEXosDownloadTarget.FILE_TARGET_QSPI, _types_HWTabletEnums__WEBPACK_IMPORTED_MODULE_15__.VEXosVID.VEXVM, _vexcode_python_vm__WEBPACK_IMPORTED_MODULE_14__.metaV5.version, function (percent) {
                progressCallback({
                  progress: percent,
                  step: _types_HWEnums__WEBPACK_IMPORTED_MODULE_1__.DownloadState.DownloadingVM
                });
    ...
    value: function triggerBLEConnectionStateChange() {
      ...
      _superPropGet(V5NativeBLE, "triggerBLEConnectionStateChange", this, 3)([]);
      if (didChangeState) {
    ...
    /**
     * Displays a modal that two connections were detected on an V5 brain
    ...
    /**
     * Called by the native Swift/Java code when an V5 brain connects
    ...
    value: (function () {
      var _onBLEDeviceConnect = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee19(name, serial, vexos) {
      ...
      function onBLEDeviceConnect(_x48, _x49, _x50) {
        return _onBLEDeviceConnect.apply(this, arguments);
      }
      return onBLEDeviceConnect;
    }()
    /**
     * Called by the native Swift/Java code when an V5 brain disconnects
     */
    )
  }, {
    ...
    value:
    /**
     * Triggers a modal to display advertising errors on an V5 brain
    ...
    value: function () {
      var _onVEXBLEDeviceDiscovered = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee20(name, vexos, serial, product, rssi) {
      ...
      function onVEXBLEDeviceDiscovered(_x51, _x52, _x53, _x54, _x55) {
    ...
    value: function () {
      var _onVEXBLEDeviceConnect = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee21(name, serial, vexos, locked, mode, cpu0Version, cpu1Version) {
      ...
      function onVEXBLEDeviceConnect(_x56, _x57, _x58, _x59, _x60, _x61, _x62) {
    ...
    value: (function () {
      var _displayLockCodePrompt = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee23(deviceID) {
        var _this7 = this;
        ...
        return _regeneratorRuntime().wrap(function _callee23$(_context23) {
          while (1) switch (_context23.prev = _context23.next) {
            case 0:
              ...
              recentBrain = _StorageInterface_VEXcodeLocalStorage__WEBPACK_IMPORTED_MODULE_17__.storageInterface.readKey(_brainInfoStore__WEBPACK_IMPORTED_MODULE_13__.brainRecentKey);
              if (recentBrain && recentBrain !== deviceID.toString()) {
                ...
                _StorageInterface_VEXcodeLocalStorage__WEBPACK_IMPORTED_MODULE_17__.storageInterface.clearKey(BRAIN_LOCK_KEY + recentBrain);
              }

              // get the previous lock code if it exists so that we can try to skip the prompt
              brainKey = BRAIN_LOCK_KEY + deviceID;
              currKey = _StorageInterface_VEXcodeLocalStorage__WEBPACK_IMPORTED_MODULE_17__.storageInterface.readKey(brainKey);
            ...
            case 11:
              _widget_Modal__WEBPACK_IMPORTED_MODULE_10__.MODALCONTROL.showBrainLockCodePrompt(this.lockCodeValidator, /*#__PURE__*/function () {
                var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee22(result) {
                  return _regeneratorRuntime().wrap(function _callee22$(_context22) {
                    while (1) switch (_context22.prev = _context22.next) {
                      ...
                      case 4:
                        ...
                        _StorageInterface_VEXcodeLocalStorage__WEBPACK_IMPORTED_MODULE_17__.storageInterface.writeKey(brainKey, result);
                        _context22.next = 11;
                        break;
                      case 9:
            ...
            case 14:
              ...
              // V5 needs to have the code displayed before it can accept the actual code?
              _context23.next = 17;
              return _nativeInterface__WEBPACK_IMPORTED_MODULE_7__.vexBLEShowLockCode(true);
            case 17:
              _context23.next = 19;
            ...
            case 23:
              ...
              _StorageInterface_VEXcodeLocalStorage__WEBPACK_IMPORTED_MODULE_17__.storageInterface.clearKey(brainKey);
      ...
      function displayLockCodePrompt(_x63) {
...
//# sourceMappingURL=47d93cb7aea384633678.src_HardwareInterface_DownloadPlatform_V5_V5NativeBLE_ts.bundle.js.map