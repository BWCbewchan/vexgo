"use strict";
(self["webpackChunkwebapp"] = self["webpackChunkwebapp"] || []).push([["src_HardwareInterface_DownloadPlatform_EXP_EXPInterface_ts"],{

/***/ "./src/HardwareInterface/DownloadPlatform/EXP/EXPInterface.ts":
/*!********************************************************************!*\
  !*** ./src/HardwareInterface/DownloadPlatform/EXP/EXPInterface.ts ***!
  \********************************************************************/
...
/* harmony export */   EXPInterface: () => (/* binding */ EXPInterface)
/* harmony export */ });
...
/* harmony import */ var _appVersionInfo__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../appVersionInfo */ "./src/appVersionInfo.ts");
...
var EXPInterface = /*#__PURE__*/function (_DownloadPlatformInte) {
  function EXPInterface() {
    var _this;
    _classCallCheck(this, EXPInterface);
    _this = _callSuper(this, EXPInterface);
  ...
  _inherits(EXPInterface, _DownloadPlatformInte);
  return _createClass(EXPInterface, [{
    ...
    value: function getSDKVersion() {
      return ["SDK " + (0,_appVersionInfo__WEBPACK_IMPORTED_MODULE_5__.sdkVersionEXP)()];
    }
    ...
    // none of the script commands methods are supported by EXP.
    ...
    // none of the remote control methods are supported by EXP.
    ...
    value: function checkDeviceFirmware(device) {
      throw new _types_HWErrors__WEBPACK_IMPORTED_MODULE_2__.OperationNotSupportedError();
    }
    //#endregion firmware
...
//# sourceMappingURL=342fd184f5395de025b8.src_HardwareInterface_DownloadPlatform_EXP_EXPInterface_ts.bundle.js.map